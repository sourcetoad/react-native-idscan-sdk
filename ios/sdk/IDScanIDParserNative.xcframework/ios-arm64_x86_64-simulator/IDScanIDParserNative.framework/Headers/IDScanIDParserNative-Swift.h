...
SWIFT_EXTERN void freeResult(char * _Nullable result) SWIFT_NOEXCEPT;

SWIFT_EXTERN char * _Nullable parseDL(char const * _Nonnull trackString) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;

SWIFT_EXTERN BOOL setLicense(char const * _Nonnull licenseKey) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;
